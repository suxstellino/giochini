...
export const MISSIONS = {
  moon: {
    ...
    createObstacles: () => makeObstacleSet(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.obstacleRock, PALETTE.obstacleRockDark),
  ...
  venus: {
    ...
    createObstacles: () => ({
      ...makeObstacleSet(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.obstacleRock, PALETTE.obstacleRockDark),
      creature: makeCreature(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.agriGreen, PALETTE.eyeGlow),
    }),
  ...
  mars: {
    ...
    createObstacles: () => ({
      ...makeObstacleSet(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.obstacleRock, PALETTE.obstacleRockDark),
      creature: makeCreature(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.scalinoTan, PALETTE.eyeGlow),
    }),
  ...
  saturn: {
    ...
    createObstacles: () => ({
      ...makeObstacleSet(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.obstacleRock, PALETTE.obstacleRockDark),
      creature: makeCreature(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.gasolioGrey, PALETTE.eyeGlow),
    }),
  ...
  neptune: {
    ...
    createObstacles: () => ({
      ...makeObstacleSet(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.obstacleRock, PALETTE.obstacleRockDark),
      creature: makeCreature(PALETTE.obstacleRock, PALETTE.obstacleRockDark, PALETTE.acquazzoneTeal, PALETTE.eyeGlow),
    }),
